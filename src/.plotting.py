...
from tracking_only.rov_states import EskfState, NominalState, ErrorState, GnssMeasurement, ImuMeasurement
...
class Mystring(str):
    ...
    _mapping = {
        ...
        'accm_bias':    [bold+'{a_b}',        'm/s^2'],
        'accm_bias.x':  ['a_{bx}',            'm/s^2'],
        'accm_bias.y':  ['a_{by}',            'm/s^2'],
        'accm_bias.z':  ['a_{bz}',            'm/s^2'],

        'gyro_bias':    [bold+'{\\omega_b}',    'rad/s'],
        'gyro_bias.x':  ['\\omega_{bx}',      'rad/s'],
        'gyro_bias.y':  ['\\omega_{by}',      'rad/s'],
        'gyro_bias.z':  ['\\omega_{bz}',      'rad/s'],
...
class PlotterESKF:
    ...
    def show(self):
        ...
        self.imu_plots()
        it = zip(
            ('pos', 'vel', 'euler', 'accm_bias', 'gyro_bias'),
