...
from tracking_only.states import RovNominalState, RovEskfState, RovErrorState
...
class ModelCV:
    ...
    def predict_nom(self,
                    x_est_nom: RovNominalState,
                    dt: float) -> RovNominalState:
        ...
        x_nom_pred = RovNominalState(pos_pred, vel_pred, ori_pred, acc_bias_pred, gyro_bias_pred)
    ...
    def predict_err(self,
        ...
        x_err_pred = MultiVarGauss[RovErrorState](RovErrorState.from_array(mean_pred), P_pred)
